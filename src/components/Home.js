...
const Home = () => {
  ...
  const highlights = [
    ...
    },
    {
      id: 2,
      icon: "🔍",
      title: "근본적인 문제를 찾아 해결합니다",
      description: "모든 증상에는 원인이 있고, 표면적인 문제만 해결한다면 얼마지나지 않아 더 큰 문제로 돌아온다고 생각합니다. 화면이 느리거나 값이 잘못되었을 때 임시방편 대신 로그와 쿼리 실행 계획을 따라가며 근본 원인까지 좁혀 들어가고, 구조 자체를 고치는 쪽을 택합니다."
    }
  ];
